...
# + copyRequiresWriterPermission - Whether the options to copy, print, or download this file, 
...
# + permissions - The full list of permissions for the file. 
...
# + headRevisionId - The ID of the file's head revision. 
...
# + md5Checksum - The MD5 checksum for the content of the file. 
#                 This is only applicable to files with binary content in Google Drive.  
# + fileExtension - The final component of fullFileExtension. 
#                   This is only available for files with binary content in Google Drive.  
# + fullFileExtension - The full file extension extracted from the name field. 
...
# + capabilities - Capabilities the current user has on this file. 
...
# + originalFilename - The original filename of the uploaded content if available, 
...
#
# + reason - Reason for why the content of the file is restricted. 
...
#                    The value of this field is a snapshot of the target's MIME type, 
...
#                      since all documents were not searched. 
#                      This may occur when searching multiple drives with the "allDrives" corpora, 
#                      but all corpora could not be searched. 
#                      When this happens, it is suggested that clients narrow their query by choosing 
